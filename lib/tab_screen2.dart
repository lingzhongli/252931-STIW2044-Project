...
import 'package:my_hires/job.dart';
import 'package:my_hires/newjob.dart';
import 'package:geolocator/geolocator.dart';
import 'package:flutter/services.dart';
import 'package:my_hires/registrationscreen.dart';
import 'package:my_hires/jobdetail.dart';
import 'package:my_hires/user.dart';
...
class _TabScreen2State extends State<TabScreen2> {
                              ...
                              children: <Widget>[
                                 Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    fit: BoxFit.fill,
                                    image: NetworkImage(
                                    "http://hireelectrian.com/my_hire/images/${data[index]['jobimage']}.jpg"
                                  )))),
                                Expanded(
                                  child: Container(
                                    child: Column(
  ...
  Future<String> makeRequest() async {
    String urlLoadJobs = "http://hireelectrian.com/my_hire/php/load_job_user.php";
  ...
  Future<String> deleteRequest(String jobid) async {
    String urlLoadJobs = "http://hireelectrian.com/my_hire/php/delete_job.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
